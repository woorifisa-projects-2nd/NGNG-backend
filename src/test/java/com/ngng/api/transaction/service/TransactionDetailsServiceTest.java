...
import com.ngng.api.transaction.dto.UpdateTransactionRequestDTO;
...
class TransactionDetailsServiceTest {
    ...
    @Test
    @DisplayName("거래 내역을 생성한다. 문제점 거래 내역 id로 검사하면 auto increment 값이 1씩 늘어나므로 확인하기 골치아픔")
    void create() {
        Long productId = 6L;
        Long buyerId =3L;
        Long price = 400L;
...
//        int newTransactionId = 10;
        ...
        CreateTransactionDetailsRequestDTO req = new CreateTransactionDetailsRequestDTO(productId,buyerId,price);
